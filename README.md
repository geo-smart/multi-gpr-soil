...
| Brendan M. | I would like some exposure to ML techniques | I can help with vibes and training and standardizing the model | Team Member | Hailey S. | I want to learn about Gaussian processes and how to migrate workflows to the cloud. | I can help with raster data and general machine learning theories. | Team Member |
